/*
 *
 * TransactionPayMentList actions
 *
 */
...
export function getTransactionPayMentList() {
  return {
    type: GET_TRANSACTIONPAYMENT_LIST,
  };
}

export function getTransactionPayMentListSuccess(response) {
  return {
...
export function getTransactionPayMentListFail(error) {
  return {
