...
export function RequestWithdrawUserList(props) {
  ...
  useEffect(() => {
    ...
    console.log("Đã gọi lại lấy request withdraw");
    console.log("Đã gọi lại lấy request withdraw: ", requestWithdraw);
  }, [urlImgCloud]);
  ...
  return (
    <div>
      <Helmet>
        <title>requestWithdrawUserList</title>
        <meta
          name="description"
      ...
      <div className="order-list-wrapper container-fluid">
        <div className="title-abc">Nhật Ký Rút Tiền</div>
        <div style={{ width: '100%' }}>
          <DataGrid
